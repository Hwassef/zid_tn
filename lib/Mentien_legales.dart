...
class Mention_Legales extends StatelessWidget {
  @override
      ...
      body: NotificationListener<OverscrollIndicatorNotification>(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: Container(
                margin: EdgeInsets.only(left: 24.0, right: 30.0),
                child: ListView(
                  ...
                  children: <Widget>[
                        ...
                        children: <Widget>[
                          Row(
                            children: [
                              Expanded(
                                child: Text(
                                  "Id incididunt velit aute est ut aliqua",
                                  style: GoogleFonts.roboto(
                                    fontSize: 16.0,
                                    color: Colors.black,
                                  ),
                    ...
                    Container(
                      child: Wrap(
                        children: <Widget>[
                          SelectableText(
                            "Occaecat aute est nostrud et est culpa sit magna aute occaecat. Duis in nostrud consectetur sit. Tempor mollit reprehenderit veniam consectetur pariatur.",
                            style: GoogleFonts.roboto(
                              fontSize: 16.0,
                              color: Colors.black,
                            ),
